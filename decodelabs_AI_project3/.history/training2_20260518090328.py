...
from sklearn.metrics.similarity import cosine_similarity
...
get_recommendations("user_skills_raw: str", vectorizer, item_matrix, job_roles: list, top_n: int = 3) -> list:
