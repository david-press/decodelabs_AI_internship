...
WHAT THIS PROGRAM DOES:
    You type in skills you already know (e.g. "Python", "SQL", "Machine Learning")
    The program figures out which tech career role fits you BEST using math — not guesswork.
    It returns the TOP 3 most matching job roles with a % match score.

HOW IT WORKS (THE FULL PIPELINE):
    Step 1 — Ingestion:   Read your skills input
    Step 2 — Scoring:     Calculate Cosine Similarity (with TF-IDF weights) for every job role
    Step 3 — Sorting:     Sort all scores highest → lowest
    Step 4 — Filtering:   Return only Top-N results to avoid choice overload

CONCEPTS USED:
    - Content-Based Filtering (match user features to item features)
...
# When you run this file directly, __name__ == '__main__' is True.
# When this file is imported as a module, this block is SKIPPED.
